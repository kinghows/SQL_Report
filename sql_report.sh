...
python SendEmail.py -p emailset101.ini -f $report_base/my_report101_$datetime.html
python SendEmail.py -p emailset102.ini -f $report_base/my_report102_$datetime.html